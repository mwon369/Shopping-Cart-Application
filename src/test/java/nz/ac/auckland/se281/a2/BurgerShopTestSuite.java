...
public class BurgerShopTestSuite {
	...
	public static class YourTest extends TaskTest {
		...
		@Test
		public void MyTests_01_add_one_burger_add_one_drink() {
			runCommands(ADD + " 1", ADD + " 13", "M", SHOW_CART);
			assertContains("0 - Avocado Burger: $17.00" + nl + "1 - Sprite (M): $2.00" + nl + "Total: $19.00");
		}
	}
